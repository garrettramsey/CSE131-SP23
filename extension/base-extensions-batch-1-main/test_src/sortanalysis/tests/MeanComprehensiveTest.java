...
public class MeanComprehensiveTest {
	private final List<Integer> originalValues;
	private final String expectedOutput;

	public MeanComprehensiveTest(List<Integer> originalValues, String expectedOutput) {
	...
	public void test() throws Exception {
		PrefixedLineTester tester = new DsaPrefixedLineTester(originalValues, expectedOutput, DsaPrefixedLine.MEAN);
