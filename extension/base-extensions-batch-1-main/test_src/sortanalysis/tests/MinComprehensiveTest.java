...
public class MinComprehensiveTest {
	private final List<Integer> originalValues;
	private final String expectedOutput;

	public MinComprehensiveTest(List<Integer> originalValues, String expectedOutput) {
	...
	public void test() throws Exception {
		PrefixedLineTester tester = new DsaPrefixedLineTester(originalValues, expectedOutput, DsaPrefixedLine.MIN);
